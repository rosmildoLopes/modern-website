...
const Hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <h1
        className="font-poppins font-semibold text-[52px] ss:text-[68px] w-full text-white 
    ...
    <div className={`flex flex-1${styles.flexCenter} my-10 md:my-0 relative`}>
      <img src={robot} alt="robot hand" className="w-full h-full z-5 relative"/>
      <div className="z-0 absolute w-[40%] h-[35%] top-0 pink__gradient"/>
      <div className="z-1 absolute w-[80%] h-[80%] white__gradient rounded-full bottom-40"/>
      <div className="z-0 absolute w-[50%] h-[50%] right-20 bottom-20 blue__gradient rounded-full"/>
    </div>

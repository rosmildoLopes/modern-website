...
const Billing = () => (
  <section id="product" className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      <div className="z-[3] -left-1/2 top-0 w-1/2 h-1/2 rounded-full absolute white__gradient" />
      <div className="z-[0] -left-1/2 bottom-0 w-1/2 h-1/2 rounded-full absolute pink__gradient" />
    </div>
